...
//Create a SQL statement
		...
		//Make a query
		// " a\"" +  +  "\"c "
		String queryString = "select day, count(bill_id) as busy from bills where bar=\""+bar+"\" group by day order by busy";
		...
		ResultSet result = stmt.executeQuery(queryString);
   		...
   		while (result.next()) { 
   			map=new HashMap<String,Integer>();
   	   		map.put(result.getString("day"),result.getInt("busy"));
   			list.add(map);
   	    } 
   	    result.close();
        ...
        for(Map<String,Integer> hashmap : list){
            	...
            	while (it.hasNext()) { 
           		...
           		String key = pair.getKey().toString().replaceAll("'", "").replaceAll("\n", "");
