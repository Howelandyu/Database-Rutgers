...
//Create a SQL statement
		...
		//Make a query
		// " a\"" +  +  "\"c "
		String queryString = "select  day, sum(total_price) as spending from bills where drinker=\""+drinker+"\" group by day";
		...
		ResultSet result = stmt.executeQuery(queryString);
   		...
   		while (result.next()) { 
   			map=new HashMap<String,Integer>();
   	   		map.put(result.getString("day"),result.getInt("spending"));
   			list.add(map);
   	    } 
   	    result.close();
		...
		chartTitle = "spending at different day";
        legend="day";
