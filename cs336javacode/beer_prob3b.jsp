...
//Create a SQL statement
		...
		//Make a query
		// " a\"" +  +  "\"c "
		String queryString = "select b.day,sum(t.quantity) as mostsell from transactions t, bills b where t.bill_id=b.bill_id and t.item=\""+beer+"\" and t.type='beer' group by day order by mostsell desc";
		...
		ResultSet result = stmt.executeQuery(queryString);
   		...
   		while (result.next()) { 
   			map=new HashMap<String,Integer>();
   	   		map.put(result.getString("b.day"),result.getInt("mostsell"));
   			list.add(map);
   	    } 
   	    result.close();
		...
		chartTitle = "selling at different day";
        legend="b.day";
