...
//Create a SQL statement
		...
		//Make a query
		// " a\"" +  +  "\"c "
		String queryString = "select hour(b.`time`) as hour,sum(t.quantity) as mostsell from transactions t, bills b where t.bill_id=b.bill_id and t.item=\""+beer+"\"and t.type='beer' group by hour order by mostsell desc";
		...
		ResultSet result = stmt.executeQuery(queryString);
   		...
   		while (result.next()) { 
   			map=new HashMap<String,Integer>();
   	   		map.put(result.getString("hour"),result.getInt("mostsell"));
   			list.add(map);
   	    } 
   	    result.close();
		...
		chartTitle = "selling at different time";
        legend="hour";
