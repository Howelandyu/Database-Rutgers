...
//Create a SQL statement
		...
		//Make a query
		// " a\"" +  +  "\"c "
		String queryString = "select month(`date`) as month, sum(total_price) as spending from bills where drinker=\""+drinker+"\" group by month";
		...
		ResultSet result = stmt.executeQuery(queryString);
   		...
   		while (result.next()) { 
   			map=new HashMap<String,Integer>();
   	   		map.put(result.getString("month"),result.getInt("spending"));
   			list.add(map);
   	    } 
   	    result.close();
		...
		chartTitle = "spending at different month";
        legend="month";
