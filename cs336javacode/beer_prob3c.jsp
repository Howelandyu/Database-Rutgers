...
//Create a SQL statement
		...
		System.out.println("Query Beer: " + beer);
		//Make a query
		// " a\"" +  +  "\"c "
		String queryString = "select month(b.`date`) as month,sum(t.quantity) as mostsell from transactions t, bills b where t.bill_id=b.bill_id and t.item=\""+beer+"\" and t.type='beer' group by month order by mostsell desc";
		...
		ResultSet result = stmt.executeQuery(queryString);
   		...
   		while (result.next()) { 
   			map=new HashMap<String,Integer>();
   	   		map.put(result.getString("month"),result.getInt("mostsell"));
   			list.add(map);
   	    } 
   	    result.close();
		...
		chartTitle = "selling at different month";
        legend="month";
